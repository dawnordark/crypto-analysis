...
def is_latest_highest(oi_series):  # 修复：参数名改为 oi_series
...
def analyze_symbol(symbol):
    try:
        ...
        if len(daily_series) >= 30:
            daily_status = is_latest_highest(daily_series)  # 修复：传递正确的参数
            ...
            if daily_status:
                ...
                for period in VALID_PERIODS:
                    ...
                    status = len(oi_series) >= 30 and is_latest_highest(oi_series)  # 修复：传递正确的参数
